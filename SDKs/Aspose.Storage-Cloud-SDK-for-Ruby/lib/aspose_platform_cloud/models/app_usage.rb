  ...
  class AppUsage
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'Barcodes')
        self.barcodes = attributes[:'Barcodes']
      end

      if attributes.has_key?(:'Ocrs')
        self.ocrs = attributes[:'Ocrs']
      end
    ...
    def list_invalid_properties
      ...
      if @ocrs.nil?
        invalid_properties.push("invalid value for 'ocrs', ocrs cannot be nil.")
      end
    ...
    def hash
      [documents, barcodes, ocrs, calls].hash
    end
